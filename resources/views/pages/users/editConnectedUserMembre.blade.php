        ...
        <div class="card-body">
          <div class="mb-4">
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="me-4">
                @if($user->image)
                  <img src="{{ asset('storage/' . $user->image) }}" alt="Image actuelle" class="rounded-circle shadow-sm" style="width: 140px; height: 140px; object-fit: cover;">
                @else
                  <div class="rounded-circle bg-light d-flex align-items-center justify-content-center shadow-sm" style="width: 140px; height: 140px;">
            ...
            <div id="imagePreview" class="mt-3 text-center" style="display: none;">
              <img id="preview" src="#" alt="Aperçu de la nouvelle image" class="rounded-circle shadow-sm" style="width: 140px; height: 140px; object-fit: cover;">
            </div>
          </div>
      ...
      <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <textarea class="form-control" id="biographyTextarea" name="biography" rows="3">{{ $user->biography }}</textarea>
          </div>
          <div class="mb-3">
            <label for="activitiesTextarea" class="form-label">Activités</label>
            <textarea class="form-control" id="activitiesTextarea" name="activities" rows="3">{{ $user->activities }}</textarea>
          </div>
        </div>
      </div>
    </div>
...
<form action="{{ route('user.update.connected.membre.user', $user->id) }}" method="POST" enctype="multipart/form-data" id="mainForm">
  @csrf
  @method('PUT')
  <!-- Les champs du formulaire sont inclus dans les onglets -->
</form>
