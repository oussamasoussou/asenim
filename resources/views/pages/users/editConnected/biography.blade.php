...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-pills flex-column flex-md-row mb-3">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('users.connected.edit.professionnelle') }}"><i
        ...
        <div class="card mb-4">
            ...
            <form method="POST" action="{{ route('users.connected.update.biography') }}" enctype="multipart/form-data">
                @csrf
                @method('POST')
