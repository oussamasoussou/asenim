...
<div>
    <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
        <div class="d-flex flex-column flex-sm-row align-items-start align-items-sm-center gap-3 mb-2 mb-sm-0">
            <h5 class="mb-0 me-3">Liste des utilisateurs</h5>
            <a href="#" class="text-decoration-none d-flex align-items-center gap-2">
                <span class="tf-icons bx bx-archive-in"></span>
                <a href="{{ route('users.archives') }}">
        ...
        <table class="table">
            <thead>
                <tr>
                    <th>
                        <a
                            href="{{ route('users.index', ['sort' => 'name', 'order' => request('order') == 'asc' ? 'desc' : 'asc']) }}" style="color:#566a7f">
                            Nom & Prénom
                            <i
                    ...
                    <th>
                        <a
                            href="{{ route('users.index', ['sort' => 'email', 'order' => request('order') == 'asc' ? 'desc' : 'asc']) }}" style="color:#566a7f">
                            Email
                            <i
                    ...
                    <th>
                        <a
                            href="{{ route('users.index', ['sort' => 'phone', 'order' => request('order') == 'asc' ? 'desc' : 'asc']) }}" style="color:#566a7f">
                            Téléphone
                            <i
                    ...
                    <th>
                        <a
                            href="{{ route('users.index', ['sort' => 'role', 'order' => request('order') == 'asc' ? 'desc' : 'asc']) }}" style="color:#566a7f">
                            Rôle
                            <i
                ...
                @foreach($users as $user)
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Bouton de suppression qui ouvre la modale -->
