...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-pills flex-column flex-md-row mb-3">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('users.edit.professionnelle', $user->id) }}" ><i class='bx bx-align-justify'></i>
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" id="first_name" name="first_name"
                                    placeholder="Prénom" value="{{ old('first_name', $user->first_name) }}">
                            </div>
                            @error('first_name')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" id="last_name" name="last_name"
                                    placeholder="Nom" value="{{ old('last_name', $user->last_name) }}">
                            </div>
                            @error('last_name')
                                <span class="text-danger">* {{ $message }}</span>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="email" id="email" name="email" class="form-control"
                                    placeholder="Adresse email" value="{{ old('email', $user->email) }}">
                            </div>
                            @if(session('error'))
                        ...
                        <div class="mb-3">
                            ...
                            <select id="role" name="role" class="form-control">
                                ...
                                <option value="membre" {{ old('role', $user->role) == 'membre' ? 'selected' : '' }}>Membre
                                </option>
                            </select>
                            @error('role')
                                <span class="text-danger">* {{ $message }}</span>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="type" name="type" class="form-control">
                                <option value="all_members" {{ old('type', $user->type) == 'all_members' ? 'selected' : '' }}>
                                    Tous les membres
                                </option>
                                <option value="permanent" {{ old('type', $user->type) == 'permanent' ? 'selected' : '' }}>
                                    Permanent
                                </option>
                                <option value="non_permanent" {{ old('type', $user->type) == 'non_permanent' ? 'selected' : '' }}>
                                    Non Permanent
                                </option>
                            </select>
                            @error('type')
