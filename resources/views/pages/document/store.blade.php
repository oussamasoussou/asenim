...
@section('title', 'Télécharger un document')
            ...
            <form method="POST" action="{{ route('documents.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select id="member_type" name="member_type" class="form-control">
                        <option value="all_members" {{ old('member_type') == 'all_members' ? 'selected' : '' }}>Tous les
                            membres</option>
                        <option value="permanent" {{ old('member_type') == 'permanent' ? 'selected' : '' }}>Permanent
                        </option>
                        <option value="non_permanent" {{ old('member_type') == 'non_permanent' ? 'selected' : '' }}>Non
                            Permanent</option>
